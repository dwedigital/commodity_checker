...
# docker build -t tariffik .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name tariffik tariffik
...
# Install base packages (including libpq5 for PostgreSQL client)
